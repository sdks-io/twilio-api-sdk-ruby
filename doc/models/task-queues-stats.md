...
| `workspace_sid` | `String` | Optional | The SID of the Workspace that contains the TaskQueues.<br><br>**Constraints**: *Minimum Length*: `34`, *Maximum Length*: `34`, *Pattern*: `^WS[0-9a-fA-F]{32}$` |
