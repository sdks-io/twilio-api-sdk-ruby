...
```ruby
taskrouter_v1_workspace_cumulative_statistics_api = client.taskrouter_v1_workspace_cumulative_statistics
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `data` property of this instance returns the response data which is of type [`WorkspaceCumulativeStatistics`](../../doc/models/workspace-cumulative-statistics.md).
...
result = taskrouter_v1_workspace_cumulative_statistics_api.fetch_workspace_cumulative_statistics(
  workspace_sid,
  end_date: end_date,
