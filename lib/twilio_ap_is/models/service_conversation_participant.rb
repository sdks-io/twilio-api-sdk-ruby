...
require 'date'
module TwilioApIs
  # ServiceConversationParticipant Model.
  class ServiceConversationParticipant < BaseModel
    SKIP = Object.new
    ...
    def initialize(account_sid: SKIP, chat_service_sid: SKIP,
                   conversation_sid: SKIP, sid: SKIP, identity: SKIP,
                   attributes: SKIP, messaging_binding: SKIP, role_sid: SKIP,
                   date_created: SKIP, date_updated: SKIP, url: SKIP,
                   last_read_message_index: SKIP, last_read_timestamp: SKIP,
    ...
    def self.from_hash(hash)
      ...
      ServiceConversationParticipant.new(account_sid: account_sid,
    ...
    def to_s
      ...
      " conversation_sid: #{@conversation_sid}, sid: #{@sid}, identity: #{@identity}, attributes:"\
      " #{@attributes}, messaging_binding: #{@messaging_binding}, role_sid: #{@role_sid},"\
      " date_created: #{@date_created}, date_updated: #{@date_updated}, url: #{@url},"\
      " last_read_message_index: #{@last_read_message_index}, last_read_timestamp:"\
      " #{@last_read_timestamp}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@sid.inspect}, identity: #{@identity.inspect}, attributes: #{@attributes.inspect},"\
      " messaging_binding: #{@messaging_binding.inspect}, role_sid: #{@role_sid.inspect},"\
      " date_created: #{@date_created.inspect}, date_updated: #{@date_updated.inspect}, url:"\
      " #{@url.inspect}, last_read_message_index: #{@last_read_message_index.inspect},"\
      " last_read_timestamp: #{@last_read_timestamp.inspect}, additional_properties:"\
